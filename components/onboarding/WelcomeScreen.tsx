...
const WelcomeScreen: React.FC = () => {
    ...
    const FeatureCard: React.FC<{ icon: string; title: string; description: string }> = ({ icon, title, description }) => (
        <div className="bg-white/80 dark:bg-[#1A3129]/50 backdrop-blur-sm rounded-lg p-4 flex flex-col items-start text-left shadow-sm transition-colors duration-300">
